  ...
  pt: [
    {
      id: 1,
      name: "Lucas Mendes",
      role: "Estudante de Medicina - UPAP",
      content: "Melhor smash de Ciudad del Este! Pedi no meio do estudo e chegou quentinho em 20 minutos. O Kit Reanimação salvou a galera toda!",
      rating: 5,
      avatar: "LM",
    },
    {
    ...
    },
    {
      ...
      role: "Morador de Ciudad del Este",
      content: "Atendimento excelente e entrega sempre pontual. O pessoal já conhece meus pedidos. Recomendo demais!",
      rating: 5,
      avatar: "RO",
    },
  ],
  es: [
    {
      id: 1,
      name: "Carlos Benítez",
      role: "Estudiante de Medicina - UPAP",
      content: "¡El mejor smash de Ciudad del Este! Pedí mientras estudiaba y llegó caliente en 20 minutos. El Kit Reanimación salvó a todo el grupo.",
      rating: 5,
      avatar: "CB",
    },
    {
    ...
    },
    {
      id: 3,
      name: "Rafael Ortiz",
      role: "Vecino de Ciudad del Este",
      content: "Excelente atención y delivery siempre puntual. El personal ya conoce mis pedidos. ¡Super recomendado!",
      rating: 5,
      avatar: "RO",
    },
  ],
